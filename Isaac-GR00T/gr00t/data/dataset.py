...
class LeRobotSingleDataset(Dataset):
    ...
    def __init__(
        ...
        if "end_effector_rotation_relative" in state_modalities:
            state_modalities["end_effector_rotation_relative"].rotation_type = (
...
class LeRobotMixtureDataset(Dataset):
    ...
    def _rng_for_index(self, index: int) -> np.random.Generator:
        ...
        seed = safe_hash((self.seed, epoch, index))
    ...
    def sample_step(self, index: int) -> tuple[LeRobotSingleDataset, int, int]:
        ...
        # Sample step
        base_index = int(rng.integers(dataset.trajectory_lengths[trajectory_index]))
