...
COMMON_PREDICATES = [
    ("forbidden_contact", R.forbidden_contact),
    ("forbidden_contact_sustained", R.forbidden_contact_sustained),
    ("allowed_contact", R.allowed_contact),
    ("robot_correct_manipulated_object_contact", R.robot_correct_manipulated_object_contact),
    ("robot_correct_fixture_contact", R.robot_correct_fixture_contact),
    (
        "correct_manipulated_object_correct_fixture_contact",
        R.correct_manipulated_object_correct_fixture_contact,
    ),
    (
        "correct_manipulated_object_correct_receive_object_contact",
        R.correct_manipulated_object_correct_receive_object_contact,
    ),
    ("grasped_object_exists", R.grasped_object_exists),
    ("object_grasped", R.object_grasped),
    ("object_stable", R.object_stable),
    ("object_stable_relative", R.object_stable_relative),
    ("object_sync", R.object_sync),
    ...
    ("object_supported_on_correct", R.object_supported_on_correct),
    ("gripper_away_from_object", R.gripper_away_from_object),
    ("object_settled", R.object_settled),
    ("release_object_settle_timeout", R.release_object_settle_timeout),
    ("object_settle_timeout", R.object_settle_timeout),
    ("gripper_is_opening", R.gripper_is_opening),
    ...
    ("skill_pick_onset", R.skill_pick_onset),
    ("skill_place_onset", R.skill_place_onset),
    ("object_region_clear", R.object_region_clear),
    ("object_upright_if_receptacle", R.object_upright_if_receptacle),
    ("preconditions_satisfied_pick", R.preconditions_satisfied_pick),
    ("pick_precondition_escape", R.pick_precondition_escape),
    ("support_region_clear", R.support_region_clear),
    ("support_stable", R.support_stable),
    ("support_geometry_valid", R.support_geometry_valid),
    ("support_type_matches_object", R.support_type_matches_object),
    ("dump_support_geometry_valid", R.dump_support_geometry_valid),
    ("dump_support_type_matches_content", R.dump_support_type_matches_content),
    ("dump_support_hygienic_for_content", R.dump_support_hygienic_for_content),
    ("dump_support_objects_clean_for_content", R.dump_support_objects_clean_for_content),
    ("dump_support_not_cluttered_for_fragile_content", R.dump_support_not_cluttered_for_fragile_content),
    ("support_hygienic_for_manipulated_object", R.support_hygienic_for_manipulated_object),
    ("support_objects_clean_for_manipulated_object", R.support_objects_clean_for_manipulated_object),
    ("support_not_cluttered_for_fragile_manipulated_object", R.support_not_cluttered_for_fragile_manipulated_object),
    ("preconditions_satisfied_place", R.preconditions_satisfied_place),
    ("place_precondition_escape", R.place_precondition_escape),
    ("skill_press_onset", R.skill_press_onset),
    ("skill_turn_onset", R.skill_turn_onset),
    ("skill_slide_onset", R.skill_slide_onset),
    ("skill_twist_onset", R.skill_twist_onset),
    ("skill_open_close_onset", R.skill_open_close_onset),
    ("skill_dump_onset", R.skill_dump_onset),
    ("target_region_clear", R.target_region_clear),
    ("target_stable", R.target_stable),
    ("fixture_ready_for_press", R.fixture_ready_for_press),
    ("fixture_ready_for_turn", R.fixture_ready_for_turn),
    ("fixture_ready_for_slide", R.fixture_ready_for_slide),
    ("fixture_ready_for_twist", R.fixture_ready_for_twist),
    ("fixture_ready_for_open_close", R.fixture_ready_for_open_close),
    ("slide_path_clear", R.slide_path_clear),
    ("target_receptacle_upright_if_has_contents", R.target_receptacle_upright_if_has_contents),
    ("articulation_path_clear", R.articulation_path_clear),
    ("preconditions_satisfied_press", R.preconditions_satisfied_press),
    ("preconditions_satisfied_turn", R.preconditions_satisfied_turn),
    ("preconditions_satisfied_slide", R.preconditions_satisfied_slide),
    ("preconditions_satisfied_twist", R.preconditions_satisfied_twist),
    ("preconditions_satisfied_open_close", R.preconditions_satisfied_open_close),
    ("preconditions_satisfied_dump", R.preconditions_satisfied_dump),
    ("dump_precondition_escape", R.dump_precondition_escape),
    # mechanism safety: fixture open/close obstacle recovery (mechanism_safety.txt)
    ("robot_fixture_contact", R.robot_fixture_contact),
    ("fixture_is_opening", R.fixture_is_opening),
    ("fixture_is_closing", R.fixture_is_closing),
    ("fixture_fully_open", R.fixture_fully_open),
    ("fixture_fully_closed", R.fixture_fully_closed),
    ("fixture_obstacle_contact", R.fixture_obstacle_contact),
    ("continue_fixture_open", R.continue_fixture_open),
    ("continue_fixture_close", R.continue_fixture_close),
    ("fixture_open_retract_path_clear", R.fixture_open_retract_path_clear),
    ("fixture_close_retract_path_clear", R.fixture_close_retract_path_clear),
    ("fixture_open_obstacle_hit", R.fixture_open_obstacle_hit),
    ...
    ("fixture_output_stopped", R.fixture_output_stopped),
    ("fixture_content_output_started", R.fixture_content_output_started),
    ("liquid_transfer_event", R.liquid_transfer_event),
    ("solid_transfer_event", R.solid_transfer_event),
    ("liquid_settled", R.liquid_settled),
    ("solid_settled", R.solid_settled),
    ("solid_misplacement", R.solid_misplacement),
    ("misplaced_solid_removed", R.misplaced_solid_removed),
    ("misplaced_solid_recollected", R.misplaced_solid_recollected),
    ("content_settled", R.content_settled),
    ("source_emptied_if_receptacle", R.source_emptied_if_receptacle),
    ("content_is_supported", R.content_is_supported),
    ("no_content_elsewhere", R.no_content_elsewhere),
    ("content_stable", R.content_stable),
    ("content_is_liquid", R.content_is_liquid),
    ("content_is_solid", R.content_is_solid),
    ...
    ("object_in_same_fixture", R.object_in_same_fixture),
]
...
TASK_AGNOSTIC_PROPERTY_SPECS = [
    ...
    # (SymbolicProperty(spec["name"], spec["ltl"], ...)), and SymbolicMonitor.step()
    ...
    _spec(
        ...
        # here regardless: SymbolicMonitor.alpha() only computes
