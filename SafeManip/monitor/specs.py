...
COMMON_PREDICATES = [
    ...
    ("grasp_point_stable", R.grasp_point_stable(R.OBJECT)),
...
PREDICATE_DESCRIPTIONS = {
    ...
    "grasp_point_stable": "The material point of the object under the fingers has not migrated across the object beyond the finger-pad-scaled bound since the grasp was established.",
